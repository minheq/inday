...
const entry = path.join(__dirname, '../app/editor/webview_script.ts');
const outputPath = path.join(__dirname, '../temp/');
const bundleFilename = 'bundle.js';
const bundleFile = outputPath + bundleFilename;

const destinationFile = path.join(__dirname, '../app/assets/quill.html');
...
<html>
  ...
  <body>
    <div class="ql-container" spellcheck="false"></div>
    <script>
      ${script}
    </script>
  </body>
