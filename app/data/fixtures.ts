...
export const col1View1: ListView = {
  ...
  fieldsConfig: {
    [col1Field1.id]: { visible: true, width: 180 },
    [col1Field2.id]: { visible: true, width: 180 },
    [col1Field3.id]: { visible: true, width: 180 },
    [col1Field4.id]: { visible: true, width: 180 },
    [col1Field5.id]: { visible: true, width: 180 },
    [col1Field6.id]: { visible: true, width: 180 },
    [col1Field7.id]: { visible: true, width: 180 },
    [col1Field8.id]: { visible: true, width: 180 },
    [col1Field9.id]: { visible: true, width: 180 },
    [col1Field10.id]: { visible: true, width: 180 },
    [col1Field11.id]: { visible: true, width: 180 },
    [col1Field12.id]: { visible: true, width: 180 },
    [col1Field13.id]: { visible: true, width: 180 },
    [col1Field14.id]: { visible: true, width: 180 },
    [col1Field15.id]: { visible: true, width: 180 },
  },
  updatedAt: new Date(),
  createdAt: new Date(),
};
